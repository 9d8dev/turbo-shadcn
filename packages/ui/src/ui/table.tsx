...
const TableBody = React.forwardRef<
	...
	React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
	<tbody ref={ref} className={cn('[&_tr:last-child]:ui-border-0', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
	<tfoot
		ref={ref}
		className={cn('ui-border-t ui-bg-muted/50 ui-font-medium [&>tr]:last:ui-border-b-0', className)}
		{...props}
	/>
));
