...
const AlertDialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
	<div
		className={cn('ui-flex ui-flex-col ui-space-y-2 ui-text-center sm:ui-text-left', className)}
		{...props}
	/>
);
...
>(({ className, ...props }, ref) => (
	<AlertDialogPrimitive.Cancel
		ref={ref}
		className={cn(buttonVariants({ variant: 'outline' }), 'ui-mt-2 sm:ui-mt-0', className)}
		{...props}
	/>
));
