...
>(({ className, ...props }, ref) => (
	<ToastPrimitives.Close
		ref={ref}
		className={cn(
			'ui-absolute ui-right-2 ui-top-2 ui-rounded-md ui-p-1 ui-text-foreground/50 ui-opacity-0 ui-transition-opacity hover:ui-text-foreground focus:ui-opacity-100 focus:ui-outline-none focus:ui-ring-2 group-hover:ui-opacity-100 group-[.destructive]:ui-text-red-300 group-[.destructive]:hover:ui-text-red-50 group-[.destructive]:focus:ui-ring-red-400 group-[.destructive]:focus:ui-ring-offset-red-600',
			className
		)}
		toast-close=""
		{...props}
