	...
	return (
		<DayPicker
			...
			classNames={{
				...
				head_row: 'ui-flex',
				head_cell: 'ui-text-muted-foreground ui-rounded-md ui-w-9 ui-font-normal ui-text-[0.8rem]',
				row: 'ui-flex ui-w-full ui-mt-2',
				cell: 'ui-h-9 ui-w-9 ui-text-center ui-text-sm ui-p-0 ui-relative [&:has([aria-selected].day-range-end)]:ui-rounded-r-md [&:has([aria-selected].day-outside)]:ui-bg-accent/50 [&:has([aria-selected])]:ui-bg-accent first:[&:has([aria-selected])]:ui-rounded-l-md last:[&:has([aria-selected])]:ui-rounded-r-md focus-within:ui-relative focus-within:ui-z-20',
				day: cn(
				...
				day_outside:
					'ui-day-outside ui-text-muted-foreground ui-opacity-50 aria-selected:ui-bg-accent/50 aria-selected:ui-text-muted-foreground aria-selected:ui-opacity-30',
				day_disabled: 'ui-text-muted-foreground ui-opacity-50',
				day_range_middle: 'aria-selected:ui-bg-accent aria-selected:ui-text-accent-foreground',
