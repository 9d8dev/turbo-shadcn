...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
	<div
		className={cn('ui-flex ui-flex-col ui-space-y-1.5 ui-text-center sm:ui-text-left', className)}
		{...props}
	/>
);
...
>(({ className, ...props }, ref) => (
	<DialogPrimitive.Title
		ref={ref}
		className={cn('ui-text-lg ui-font-semibold ui-leading-none ui-tracking-tight', className)}
		{...props}
	/>
));
